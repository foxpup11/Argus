...
- ❌ **不需要 API Key** —— 核心功能不依赖任何外部 LLM（LLM 增强为可选）
...
> 💡 **进阶提示**：如果你希望获得更高质量的会话交接摘要，可以在设置中配置 LLM（支持 OpenAI / Anthropic / 任何兼容 API）。不配置也能用——Argus 内置了基于规则的高性能提取器。
...
- [ ] **CLAUDE.md 规则遵守审计** —— 自动检查 Claude 是否遵守了你写的每一条规则
